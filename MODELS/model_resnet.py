...
class ResNet(nn.Module):
    def __init__(self, block, layers,  network_type, num_classes, att_type=None):
        ...
        if att_type=='BAM':
            self.bam1 = BAM(16*block.expansion)
            self.bam2 = BAM(32*block.expansion)
            self.bam3 = BAM(64*block.expansion)
        else:
...
def ResidualNet(network_type, depth, num_classes, att_type):
    ...
    if depth == 18:
        model = ResNet(BasicBlock, [3, 3, 3], network_type, num_classes, att_type)
